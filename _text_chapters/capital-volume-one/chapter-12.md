...
section_key: "library"
permalink: "/library/texts/capital-volume-one/chapter-12/"
...
description: "Chapter 12: The Concept of Relative Surplus-Value from Capital, Volume I, in a rights-reviewed reading edition sourced from the Marxists Internet Archive."
source_url: "https://www.marxists.org/archive/marx/works/1867-c1/ch12.htm"
...
source_sha256: "2ea8cff7764fd07fa4354cd1c139ea1e280b622a34a9a841f517c3985cc75164"
content_sha256: "8df892c4ab2a2864fdf6699ca63e281c73b35469500ca6957caff224859c9d17"
imported: true
---

<!-- Generated by scripts/import_mia_texts.mjs. Edit the manifest or importer, not this file. -->

<h3>Part IV: Production of Relative Surplus Value</h3>

<hr class="cc-text-rule">

<h3>
Chapter Twelve: The Concept of Relative Surplus Value</h3>

<hr class="cc-text-rule">



<p>That portion of the working day which merely produces
...
<p>Although the length of a c is given, b c appears to be capable
...
half of b c </p>
<p>a——b'—b—c</p>
<p>or to one hour’s labour-time. If now, in a c, the working day
...
without a simultaneous contraction of the necessary labour-time from<!--297-->
...
<a id="1a"></a></p>
<p>On the other hand, it is evident that the duration of the surplus-labour
...
of his labour-power is given; <sup><a href="#n1">[1]</a></sup> and given the value
...
the proper reproduction of his labour-power is crippled.<!--298--> The surplus-labour
...
<a id="2a"></a></p>
<p>Such a fall in the value of labour-power implies, however, that
...
<sup><a href="#n2">[2]</a></sup> Hitherto in treating of surplus-value, arising from a simple prolongation of the working day, we have assumed the mode of production
...
process, and<!--299--> consequently the very mode of production must be revolutionised,
...
<p>The surplus-value produced by prolongation of the working day,
I call <em>absolute surplus-value</em>. On the other hand, the surplus-value
...
of the working day, I call <em>relative surplus-value</em>.
</p>
<p>In order to effect a fall in the value of labour-power, the increase
...
<a id="3a"></a></p>
<p>The cheapened commodity, of course, causes only a pro tanto fall
...
value of labour-power and shortening, pro tanto<!--300--> the necessary labour-time.
But it is only in so far as he ultimately contributes to this result, that
he assists in raising the general rate of surplus-value. <sup><a href="#n3">[3]</a></sup> The general and necessary tendencies of capital must be distinguished from their forms of manifestation.
</p>
<p>It is not our intention to consider, here, the way in which the
...
<p>If one hour’s labour is embodied in sixpence, a value of six shillings
...
The individual value of these articles is now below their social value;<!--301-->
...
<a id="4a"></a></p>
<p>Nevertheless, even in this case, the increased production of surplus-value
arises from the curtailment of the necessary labour-time, and from the
corresponding prolongation of the surplus-labour. <sup><a href="#n4">[4]</a></sup>
...
9 3/5 articles.<!--302--> Since the price of the labour-power is five shillings,
...
labour of the same kind. (See <a href="/library/texts/capital-volume-one/chapter-01/#S2">Ch.
I. Sect 2.</a> p. 44.) But our capitalist still continues to pay as before
...
working day, <a id="5a"></a>than the other capitalists in the same trade. He does individually,
...
of competition, forces his competitors to adopt the new method. <sup><a href="#n5">[5]</a></sup> The general rate of surplus-value is, therefore, ultimately affected by
the whole process, only when the increase in the productiveness of labour,
has seized upon those branches of production that are<!--303--> connected with,
...
<a id="6a"></a></p>
<p>The value of commodities is in inverse ratio to the productiveness
...
and by such cheapening to cheapen the labourer himself. <sup><a href="#n6">[6]</a></sup>

<a id="7a"></a></p>
<p>The value of a commodity is, in itself, of no interest to the
...
to which they could give him no answer.<!--304--></p>
<p> “You acknowledge,” he says,
...
of the exchange-value of their products.” <sup><a href="#n7">[7]</a></sup>
<a id="8a"></a></p>

<p>The shortening of the working day is, therefore, by no means what
is aimed at, in capitalist production, when labour is economised by increasing
its productiveness. <sup><a href="#n8">[8]</a></sup> It is only the shortening of
...
of the stamp of MacCulloch, Ure, Senior, and <i>tutti quanti</i> <span class="cc-text-note-inline">[the like]</span>, we may read
...
it be influenced.” (Ramsay, l.c., pp. 168, 169.)</p>

<p class="cc-text-note"><span class="cc-text-note-label"><a href="#4a" id="n4">4.</a></span> “A man’s profit does not depend upon his command of the produce of other men’s labour, but upon his command
...
Pol. Econ.” London, 1832, pp. 49, 50.)</p>

<p class="cc-text-note"><span class="cc-text-note-label"><a href="#5a" id="n5">5.</a></span> “If my neighbour by doing much with little labour, can sell cheap, I must contrive to sell as cheap as he.
...
England,” London, 1720, p. 67.)</p>

<p class="cc-text-note"><span class="cc-text-note-label"><a href="#6a" id="n6">6.</a></span> “In whatever proportion the expenses of a labourer are diminished, in the same proportion will his wages be
