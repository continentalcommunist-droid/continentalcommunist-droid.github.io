...
section_key: "library"
permalink: "/library/texts/capital-volume-one/chapter-17/"
...
description: "Chapter 17: Changes of Magnitude in the Price of Labour-Power and in Surplus-Value from Capital, Volume I, in a rights-reviewed reading edition sourced from the Marxists Internet Archive."
...
source_sha256: "b819958edcf48dacb1c7f9e83e4608e1ef739b979f8894f5a62cd62e9700d120"
content_sha256: "36282f81a3a9cac7542725d717f12b5249dfdd49b29b6dfc9efed3a5cc2eeabc"
imported: true
---

<!-- Generated by scripts/import_mia_texts.mjs. Edit the manifest or importer, not this file. -->

<h3>Chapter Seventeen: Changes of Magnitude in the Price of Labour-Power and in Surplus-Value</h3>
...
<p class="cc-text-indent">
Section 1 - <a href="#S1">Length of the Working-Day and Intensity of Labour Constant. Productiveness of Labour Variable</a>
<br>Section 2 - <a href="#S2">Working-Day Constant. Productiveness of Labour
Constant. Intensity of Labour Variable</a>
<br>Section 3 - <a href="#S3">Productiveness and Intensity of Labour Constant.
Length of the Working-Day Variable</a>
<br>Section 4 - <a href="#S4">Simultaneous Variations in the Duration, Productiveness,
and Intensity of Labour</a>

</p><p>A. <a href="#S41">Diminishing Productiveness of Labour with
a Simultaneous Lengthening of the Working-Day</a>
<br>B. <a href="#S42">Increasing Intensity and Productiveness
of Labour with Simultaneous Shortening of the Working-Day</a>
</p>
...
<a id="1a"></a>
<p>The value of labour-power is determined by the value
...
investigation. <a id="assumptions"> </a><sup><a href="#n1">[1]</a></sup>
</p>
<p>I assume (1) that commodities are sold at their value; (2) that
the price of labour-power rises occasionally above its value, but never
sinks below it.
</p>
<p>On this assumption we have seen that the relative magnitudes of
...
<h3>LENGTH OF THE WORKING-DAY AND INTENSITY OF LABOUR CONSTANT. PRODUCTIVENESS OF LABOUR VARIABLE.</h3>

<hr class="cc-text-rule">



<p>On these assumptions the value of labour-power, and
the magnitude of surplus-value, are determined by three laws.
</p>
<p><em>(1.)</em> A working day of given length always creates the same
...
<p>If the value created by a working-day of 12 hours be, say, six
...
<p><em>(2.)</em> Surplus-value and the value of labour-power vary in
...
<p>The value created by a working day of 12 hours is a constant quantity,
...
<em>i.e.</em>, relatively to each other. It is impossible for them to rise
or fall simultaneously.
</p>
<p>Further, the value of labour-power cannot fall, and consequently
...
<p>In formulating this law, Ricardo overlooked one circumstance;
...
falls from 4 shillings to 3, <em>i.e.</em>, by 1/4 or 25%, the surplus-value
rises from 2 shillings to 3, <em>i.e.</em>, by 1/2 or 50%. It therefore follows
...
<a id="2a"></a></p>
<p><em>(3.)</em> Increase or diminution in surplus-value is always
consequent on, and never the cause of, the corresponding diminution or
increase in the value of labour-power. <sup><a href="#n2">[2]</a></sup>
</p>
<p>Since the working-day is constant in magnitude, and is represented
...
<p>According to the third law, a change in the magnitude of surplus-value,
...
<p>The value of labour-power is determined by the value of a given
...
and price of labour-power. <a id="3a"></a>The only result would be that each of them would
...
would keep widening. <sup><a href="#n3">[3]</a></sup>
</p>
<p>Ricardo was the first who accurately formulated the three laws
...
as such, <em>i.e.</em>, independently of its particular forms, such as profit,
...
<h3>WORKING-DAY CONSTANT. PRODUCTIVENESS OF LABOUR CONSTANT. INTENSITY OF LABOUR VARIABLE</h3>

<hr class="cc-text-rule">



<p>Increased intensity of labour means increased expenditure
...
<p>We know that, with transitory exceptions, a change in the productiveness
...
<a id="4a"></a></p>
<p>If the intensity of labour were to increase simultaneously and
...
day of another nation. <sup><a href="#n4">[4]</a></sup>
</p>
...
<h3>PRODUCTIVENESS AND INTENSITY OF LABOUR CONSTANT. LENGTH OF THE WORKING-DAY VARIABLE</h3>

<hr class="cc-text-rule">



<p>The working-day may vary in two ways. It may be made
either longer or shorter. From our present data, and within the limits
of the assumptions made on <a href="#assumptions">p. 487 [v. 35 MECW p. 520]</a> we obtain the following laws:</p>
<p><em>(1.)</em> The working-day creates a greater or less amount of
value in proportion to its length — thus, a variable and not a constant
quantity of value.</p>
<p><em>(2.)</em> Every change in the relation between the magnitudes
...
surplus-value.</p>
<p><em>(3.)</em> The absolute value of labour-power can change only
...
of surplus-value.</p>
<p>We begin with the case in which the working-day is shortened.</p>
<p><em>(1.)</em> A shortening of the working-day under the conditions
...
also falls, <em>i.e., </em>its magnitude relatively to the value of labour-power
...
<a id="5a"></a></p>
<p>All the usual arguments against the shortening of the working-day,
...
of the working-day. <sup><a href="#n5">[5]</a></sup>
</p>
<p><em>(2.)</em> Lengthening of the working-day. Let the necessary
...
is the result of the change of absolute magnitude in surplus-value.</p>
<p>Since the value in which a day's labour is embodied, increases
...
<a id="6a"></a></p>
<p>When the working-day is prolonged, the price of labour-power may
...
bodily matter into motion, <sup><a href="#n6">[6]</a></sup> in conformity with the
...
the degree of its exploitation cease to be commensurable quantities.</p>
...
<h3>SIMULTANEOUS VARIATIONS IN THE DURATION, PRODUCTIVENESS, AND INTENSITY OF LABOUR</h3>

<hr class="cc-text-rule">



<p>It is obvious that a large number of combinations
...
and that briefly, but two important cases.</p>



<a id="S41"></a>
<h3>A. Diminishing productiveness of labour with a simultaneous lengthening of the working-day.</h3>

<p>In speaking of diminishing productiveness of labour, we here refer to diminution
...
day be lengthened by 2 hours, <em>i.e.</em>, from 12 hours to 14, the surplus-labour
remains at 6 hours, the surplus-value at 3 shillings <sup><a href="#note">[note]</a></sup>, but the surplus-value
...
<a id="7a"></a>
<a id="8a"></a></p>
<p>In the period between 1799 and 1815 the increasing price of provisions
...
an outrageous extent was established; <sup><a href="#n7">[7]</a></sup> the period
that was especially characterised by an accelerated accumulation of capital
here, by pauperism there. <sup><a href="#n8">[8]</a></sup></p>


<a id="S42"></a>
<h3>B. Increasing intensity and productiveness of labour
with simultaneous shortening of the working-day.</h3>

<p>Increased productiveness and greater intensity of labour, both have a like
...
for reserve and accumulation.</p>
<p>The more the productiveness of labour increases, the more can
...
indispensable, but in themselves superfluous.</p>
<p>The intensity and productiveness of labour being given, the time
...
<p class="cc-text-note"><span class="cc-text-note-label"><a href="#1a" id="n1">1.</a></span> <em>Note in the 3rd German edition</em>. — The case considered at pages 321-324 is here of course omitted. — <em>F. E.</em></p>

<p class="cc-text-note"><span class="cc-text-note-label"><a href="#2a" id="n2">2.</a></span> To this third law MacCulloch has made, amongst others, this absurd addition, that a rise in surplus-value, unaccompanied by a fall in the value of labour-power, can occur through the abolition
...
<p class="cc-text-note"><span class="cc-text-note-label"><a href="#3a" id="n3">3.</a></span> “When an alteration takes place in the productiveness of industry, and that either more or less is produced
...
the same.” (“Outlines of Political Economy, &amp;c.,” p. 67.)</p>

<p class="cc-text-note"><span class="cc-text-note-label"><a href="#4a" id="n4">4.</a></span> “All things being equal, the English manufacturer can turn out a considerably larger amount of work in a given
...
of the working-day in Continental factories.</p>

<p class="cc-text-note"><span class="cc-text-note-label"><a href="#5a" id="n5">5.</a></span> “There are compensating circumstances ... which the working of the Ten Hours' Act has brought to light.” (“Rep. of Insp. of Fact. for 31st Oct. 1848,” p. 7.)</p>

<p class="cc-text-note"><span class="cc-text-note-label"><a href="#6a" id="n6">6.</a></span> “The amount of labour which a man had undergone in the course of 24 hours might be approximately arrived
...
force.” (Grove: “On the Correlation of Physical Forces.”)</p>

<p class="cc-text-note"><span class="cc-text-note-label"><a href="#7a" id="n7">7.</a></span> “Corn and labour rarely march quite abreast; but there is an obvious limit, beyond which they cannot be separated.
...
of Nature, rather than by the historical laws of capitalist production.</p>

<p class="cc-text-note"><span class="cc-text-note-label"><a href="#8a" id="n8">8.</a></span> “A principal cause of the increase of capital, during the war, proceeded from the greater exertions, and perhaps
...
Transcribed by Alan Thurrott<br>
Html Markup by Stephen Baird (1999)</p>

<h3>Note</h3>
<p class="cc-text-note"><a id="note"> </a> Earlier English translations have “6 sh.” instead of 3 shillings. This error was pointed out to us by a reader, we have investigated and checked with the 1872 German Edition and duly corrected an obvious error. See “<a href="https://www.marxists.org/archive/marx/works/1867-c1/guide/3smystery.htm" rel="external noopener">A three shilling mystery</a>”.</p>  
<p>
Andy Blunden (2002)</p>
