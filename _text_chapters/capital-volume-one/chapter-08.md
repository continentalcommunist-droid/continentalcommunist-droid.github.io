...
section_key: "library"
permalink: "/library/texts/capital-volume-one/chapter-08/"
...
description: "Chapter 8: Constant Capital and Variable Capital from Capital, Volume I, in a rights-reviewed reading edition sourced from the Marxists Internet Archive."
source_url: "https://www.marxists.org/archive/marx/works/1867-c1/ch08.htm"
...
source_sha256: "29305678233fda61edb2abf205faeb0174b4304031a049c4d316dccf37630096"
content_sha256: "aeec27f5c33102246990bf40b4ae4d565cc192d914c7d60beb72a3fa4ab82582"
imported: true
---

<!-- Generated by scripts/import_mia_texts.mjs. Edit the manifest or importer, not this file. -->

<h3>Chapter Eight: Constant Capital and Variable Capital</h3>

<hr class="cc-text-rule">



<p>The various factors of the labour-process play different
parts in forming the value of the product.</p>
<p>The labourer adds fresh value to the subject of his labour by
...
<p>The labourer does not perform two operations at once, one in order
...
<a id="1a"> </a></p>
<p>Now, in what manner does every labourer add new labour and consequently
new value? Evidently, only by labouring productively in a&nbsp;<!--194-->particular
...
elements of the product, of a new use-value. <span><a href="#1">[1]</a></span> Each
...
them to form the new products.</p>
<p>If the special productive labour of the workman were not spinning,
...
<p><!--195-->By the simple addition of a certain quantity of labour,
...
<p>Let us assume, that some invention enables the spinner to spin
...
<p>Let us now assume, that the productiveness of the spinner’s labour,
...
<p>Again, if the technical conditions of the spinning process remain
...
The value that he preserves in the product is directly&nbsp;<!--196-->proportional
...
<p>Value exists only in articles of utility, in objects: we leave
...
<p>The coal burnt under the boiler vanishes without leaving a trace;
...
after it has changed its form. Hence raw material and auxiliary&nbsp;<!--197-->substances
...
<p>It is thus strikingly clear, that means of production never transfer
...
<a id="2a"> </a></p>
<p>Yet another interesting phenomenon here presents itself. Suppose
...
the&nbsp;<!--198-->day’s product. At the same time, though with diminishing
...
only by fractions. <span><a href="#2">[2]</a></span>
</p>
<p>On the other hand, a means of production may take part as a whole
...
of new and independent use-values.&nbsp;<!--199-->Such an employment of refuse
...
<a id="3a"> </a></p>
<p>We have seen that the means of production transfer value to the
...
product, unless it possessed such value previously. <span><a href="#3">[3]</a></span>

<a id="4a"></a>
<a id="5a"> </a></p>
<p>While productive labour is changing the means of production into
...
He is unable to add new labour, to create new value,&nbsp;<!--200-->without
...
preserves the existing value of his capital. <span><a href="#4">[4]</a></span> So long
...
of the labour-process by a crisis, makes him sensitively aware of it. <span><a href="#5">[5]</a></span>

<a id="6a"> </a>
<a id="7a"> </a></p>
<p>As regards the means of production, what is really consumed is
their use-value, and the consumption of this use-value by labour results
in the product. There is no consumption of their value, <span><a href="#6">[6]</a></span>
...
<p>It is otherwise with the subjective factor of the labour-process,
...
<p>We know, however, from what has gone before, that the labour-process
...
<p>By our explanation of the different parts played by the various
...
<em>constant capital.</em>
</p>
<p>On the other hand, that part of capital, represented by labour-power,
...
part of capital, or, shortly, <em>variable capital. </em>The same elements
...
<p>The definition of constant capital given above by no means excludes
...
to the value of the cotton by the spinning itself. <a id="8a"> </a>If the old cotton had
...
species, <span><a href="#8">[8]</a></span> and their value at any given time is measured
by the labour socially necessary, <em>i.e.</em>, by the labour necessary
for their production under the then existing social conditions.
</p>
<p>As the value of the raw material may change, so, too, may that
...
<p>Just as a change in the value of the means of production, even
...
<span class="cc-text-note-label"><a href="#1a" id="1">1.</a></span> “Labour gives a new creation for one extinguished.” (“An Essay on the Polit. Econ. of Nations,” London, 1821, p. 13.)</p>

<p class="cc-text-note">
<span class="cc-text-note-label"><a href="#2a" id="2">2.</a></span> The subject of repairs of the implements
...
in the formation of value.</p>

<p class="cc-text-note">
<span class="cc-text-note-label"><a href="#3a" id="3">3.</a></span> From this we may judge of the absurdity
...
from the enjoyment of it, for which he demands, <em>e.g.</em>, interest.” 
...
into a source of value.</p>

<p class="cc-text-note">
<span class="cc-text-note-label"><a href="#4a" id="4">4.</a></span> “Of all the instruments of the farmers’
...
of November 1795,” Edit. London, 1800, p. 10.)</p>

<p class="cc-text-note">
<span class="cc-text-note-label"><a href="#5a" id="5">5.</a></span> In <em>The Times </em>of 26th November,
...
machinery is already nearly worn out.</p>

<p class="cc-text-note">
<span class="cc-text-note-label"><a href="#6a" id="6">6.</a></span> “Productive consumption ... where
...
<p class="cc-text-note">
<span class="cc-text-note-label"><a href="#7a" id="7">7.</a></span> In an American compendium that has
...
from a mere re-appearance of pre-existing values.</p>

<p class="cc-text-note">
<span class="cc-text-note-label"><a href="#8a" id="8">8.</a></span> “Toutes les productions d’un même genre ne forment proprement qu’une masse, dont le prix se détermine
