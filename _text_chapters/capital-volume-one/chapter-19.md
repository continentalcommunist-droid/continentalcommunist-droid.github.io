---
layout: "text-chapter"
title: "Chapter 19: The Transformation of the Value of Labour-Power into Wages"
content_type: "Primary Text"
section_key: "library"
permalink: "/library/texts/capital-volume-one/chapter-19/"
...
description: "Chapter 19: The Transformation of the Value of Labour-Power into Wages from Capital, Volume I, in a rights-reviewed reading edition sourced from the Marxists Internet Archive."
source_url: "https://www.marxists.org/archive/marx/works/1867-c1/ch19.htm"
...
source_sha256: "faf1aa938ea354f361157a237404347488d3d7b13df4936801856793159f5ce8"
content_sha256: "8c7a9e2c0b25964ea2cc579c12db4323595ac26c0cc4b814aacd8521747f9c33"
imported: true
---
...
<h3>Chapter Nineteen: The Transformation of the Value (and Respective Price) of Labour-Power into Wages</h3>

<hr class="cc-text-rule">



<p>On the surface of bourgeois society the wage of the
...
<a id="1a"></a></p>
<p>But what is the value of a commodity? The objective form of the
...
tautology. <sup><a href="#n1">[1]</a></sup>

<a id="2a"></a></p>
<p>In order to be sold as a commodity in the market, labour must
...
<a id="3a"></a></p>
<p>Apart from these contradictions, a direct exchange of money, i.e.,
...
be in any way even enunciated or formulated as a law. <sup><a href="#n3">[3]</a></sup>

<a id="4a"></a></p>
<p>It is of no avail to deduce the exchange of more labour against
less, from their difference of form, the one being realized, the other
living. <sup><a href="#n4">[4]</a></sup> This is the more absurd as the value of a
...
<a id="5a"></a></p>
<p>That which comes directly face to face with the possessor of money
...
itself no value. <sup><a href="#n5">[5]</a></sup>

<a id="6a"></a></p>
<p>In the expression “value of labour,” the idea of value is not
...
in every science except Political Economy. <sup><a href="#n6">[6]</a></sup>
</p>
<p>Classical Political Economy borrowed from every-day life the category
...
<p>Let us next see how value (and price) of labour-power, present
themselves in this transformed condition as wages.
</p>
<p>We know that the daily value of labour-power is calculated upon
...
<a id="7a"></a></p>
<p>As the value of labour is only an irrational expression for the
...
labour which creates a value of 6s. possesses a value of 3s. <sup><a href="#n7">[7]</a></sup>

<a id="8a"></a></p>
<p>We see, further: The value of 3s. by which a part only of the
...
labour appears as unpaid labour. <sup><a href="#n8">[8]</a></sup> In wage labour,
...
<p>Hence, we may understand the decisive importance of the transformation
...
<p>If history took a long time to get at the bottom of the mystery
of wages, nothing, on the other hand, is more easy to understand than the
necessity, the raison d’etre, of this phenomenon.

<a id="9a"></a></p>
<p>The exchange between capital and labour at first presents itself
...
most, a material difference, expressed in the juridically equivalent formula:
 “Do ut des, do ut facias, facio ut des, facio ut facias.” <sup><a href="#n9">[9]</a></sup>
</p>
<p>Furthermore, exchange-value and use-value, being intrinsically
...
<a id="10a"></a></p>
<p>Let us put ourselves in the place of the labourer who receives
...
Smith, who treated the working-day as a constant quantity, <sup><a href="#n10">[10]</a></sup> to the assertion that the value of labour is constant, although the value of the means of subsistence may vary, and the same working-day, therefore,
may represent itself in more or less money for the labourer.
</p>
<p>Let us consider, on the other hand, the capitalist. He wishes
...
<p>Moreover, the actual movement of wages presents phenomena which
...
<p>For the rest, in respect to the phenomenal form, “value and price
...
<p class="cc-text-note"><span class="cc-text-note-label"><a href="#1a" id="n1">1.</a></span> “Mr.Ricardo ingeniously enough avoids a difficulty which, on a first view, threatens to encumber his doctrine —
...
on the Nature, &amp;c., of Value,” pp. 50, 51.</p>

<p class="cc-text-note"><span class="cc-text-note-label"><a href="#2a" id="n2">2.</a></span> “If you call labour a commodity, it is not like a commodity which is first produced in order to exchange, and
...
Verbal Disputes,” &amp;c., pp. 75, 76.</p>

<p class="cc-text-note"><span class="cc-text-note-label"><a href="#3a" id="n3">3.</a></span> “Treating labour as a commodity, and capital, the produce of labour, as another, then, if the values of these
...
Vol. I., London, 1836, p. 231, note.</p>

<p class="cc-text-note"><span class="cc-text-note-label"><a href="#4a" id="n4">4.</a></span> “There has to be a new agreement” (a new edition of the social contract!) “that whenever there is an exchange
...
a higher value than the former” (the worker). — Simonde (de Sismondi),
 “De la Richesse Commerciale,” Geneva, 1803, Vol I, p. 37.</p>

<p class="cc-text-note"><span class="cc-text-note-label"><a href="#5a" id="n5">5.</a></span> “Labour the exclusive standard of value ... the creator of all wealth, no commodity.” Thomas Hodgskin, “Popul. Polit. Econ.,” p. 186.</p>

<p class="cc-text-note"><span class="cc-text-note-label"><a href="#6a" id="n6">6.</a></span> On the other hand, the attempt to explain such expressions as merely poetic license only shows the impotence
...
the wherefore of things.</p>

<p class="cc-text-note"><span class="cc-text-note-label"><a href="#7a" id="n7">7.</a></span> Cf. “Zur Kritik &amp;c.,” p. 40, where I state that, in the portion of that work that deals with Capital,
...
of labour is less than the exchange-value of its product?” </p>

<p class="cc-text-note"><span class="cc-text-note-label"><a href="#8a" id="n8">8.</a></span> The “Morning Star,” a London Free-trade organ, naif to silliness, protested again and again during the American
...
workman in the East-end of London.</p>

<p class="cc-text-note"><span class="cc-text-note-label"><a href="#9a" id="n9">9.</a></span> I give in order that you may give; I give in order that you may produce; I produce so that you may give; I produce so that you may produce.</p>

<p class="cc-text-note"><span class="cc-text-note-label"><a href="#10a" id="n10">10.</a></span> Adam Smith only accidentally alludes to the variation of the working-day when he is referring to piece-wages.</p>
