---
layout: "text-chapter"
title: "Chapter 30: Reaction of the Agricultural Revolution on Industry"
content_type: "Primary Text"
section_key: "library"
permalink: "/library/texts/capital-volume-one/chapter-30/"
...
description: "Chapter 30: Reaction of the Agricultural Revolution on Industry from Capital, Volume I, in a rights-reviewed reading edition sourced from the Marxists Internet Archive."
source_url: "https://www.marxists.org/archive/marx/works/1867-c1/ch30.htm"
...
source_sha256: "efad4d425cfebc538bd56853006d89231e5bc4eaf0e3f387a5dae8c676e330f7"
content_sha256: "731e9b8030ae0cb733601f39306d40d76c675a63b2e5390a6bbc6bbdc3fcd2e8"
imported: true
---

<!-- Generated by scripts/import_mia_texts.mjs. Edit the manifest or importer, not this file. -->

<h3>Chapter Thirty: Reaction of the Agricultural Revolution on Industry. Creation of the Home-Market for Industrial Capital</h3>
...
<a id="1a"></a>
<a id="2a"></a>
<p>The expropriation and expulsion of the agricultural
...
matter at one place, by its rarefaction at another. <sup><a href="#n1">[1]</a></sup>
...
more intensely <sup><a href="#n2">[2]</a></sup>, but the field of production on which
...
They were transformed into an element of constant capital. Suppose, <em>e.g</em>.,
...
time, in taxes pour le roi de Prusse. <a id="3a"></a>It realises itself now in profit
...
them unpaid labour. <sup><a href="#n3">[3]</a></sup> One does not perceive, when looking
...
Says Mirabeau:</p>
<p> “We are only paying attention to the grand manufactories,
in which hundreds of men work under a director and which are commonly called
<em>manufactures réunies</em>. Those where a very large number of
...
in the position to live a little better, <a id="4a"></a>but only from day to day.... The
...
of small holdings, are the only free ones.” <sup><a href="#n4">[4]</a></sup> The expropriation
...
<p>In fact, the events that transformed the small peasants into wage labourers,
...
sells them, he finds his market in manufactures. <a id="5a"></a>Yarn, linen, coarse woollen
...
by industrial capital. <sup><a href="#n5">[5]</a></sup> Thus, hand in hand with the
...
the soil as an accessary calling, find <a id="6a"></a>their chief occupation in industrial
...
of a phenomenon which, at first, puzzles the student of English history.<sup><a href="#n6">[6]</a></sup>
...
peasantry. <a id="7a"></a><a id="8a"></a>On the other hand, he always finds this peasantry turning up
...
<sup><a href="#n7">[7]</a></sup> It therefore also, for the first time, conquers for
industrial capital the entire home market. <sup><a href="#n8">[8]</a></sup>
</p>
...
<p class="cc-text-note"><span class="cc-text-note-label"><a href="#1a" id="n1">1.</a></span> In his “Notions de Philosophie Naturelle.” 
Paris, 1838.</p>

<p class="cc-text-note"><span class="cc-text-note-label"><a href="#2a" id="n2">2.</a></span> A point that Sir James Steuart emphasises.</p>

<p class="cc-text-note"><span class="cc-text-note-label"><a href="#3a" id="n3">3.</a></span> “Je permettrai,” says the capitalist, “que vous ayez l’honneur de me servir, à condition que vous me donnez le peu qui vous reste pour la peine que je prends de vous commander.” <span class="cc-text-note-inline">[I will allow you ... to have the honour of serving me, on condition that, in return for the pains I take in commanding you, you give me the little that remains to you]</span> (J. J. Rousseau: “Discours sur l’Economie Politique.”)</p>

<p class="cc-text-note"><span class="cc-text-note-label"><a href="#4a" id="n4">4.</a></span> Mirabeau, l.c., t.III, pp.20-109 passim.
...
great part of the continental manufactures.</p>

<p class="cc-text-note"><span class="cc-text-note-label"><a href="#5a" id="n5">5.</a></span> “Twenty pounds of wool converted unobtrusively into yearly clothing of a labourer’s family by its own industry in the intervals
...
commercial, monetary, and financial system.” (David Urquhart, l.c., p.120.)</p>

<p class="cc-text-note"><span class="cc-text-note-label"><a href="#6a" id="n6">6.</a></span> Cromwell’s time forms an exception.
So long as the Republic lasted, the mass of the English people of all grades
rose from the degradation into which they had sunk under the Tudors.</p>

<p class="cc-text-note"><span class="cc-text-note-label"><a href="#7a" id="n7">7.</a></span> Tuckett is aware that the modern woollen
industry has sprung, with the introduction of machinery, from manufacture
proper and from the destruction of rural and domestic industries.</p>
<p class="cc-text-note"> “The plough, the yoke, were ‘the invention of gods, and the occupation
...
agriculture and commercial.” (David Urquhart, l.c., p.122.)</p>
...
very system of protection which accelerates it.</p>

<p class="cc-text-note"><span class="cc-text-note-label"><a href="#8a" id="n8">8.</a></span> Philanthropic English economists, like Mill,
...
do <em>you</em> come from, then? From the destruction of those freeholders.
