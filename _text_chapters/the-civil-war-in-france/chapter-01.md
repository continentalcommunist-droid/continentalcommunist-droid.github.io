---
layout: "text-chapter"
title: "Chapter 1: The Beginning of the Franco-Prussian War"
content_type: "Primary Text"
section_key: "library"
permalink: "/library/texts/the-civil-war-in-france/chapter-01/"
...
description: "Chapter 1: The Beginning of the Franco-Prussian War from The Civil War in France, in a rights-reviewed reading edition sourced from the Marxists Internet Archive."
...
source_sha256: "e237a78638ec6d6184df4e7dd6103cfe9ae6fb7d022fa8c48780f39312832f0f"
content_sha256: "6aae6a6fb2904e5f746050f0e63411fbc1c365619edb397817e79a698cf08617"
imported: true
---

<!-- Generated by scripts/import_mia_texts.mjs. Edit the manifest or importer, not this file. -->

<p>In the <a href="https://www.marxists.org/archive/marx/works/1864/10/27.htm" rel="external noopener">Inaugural Address</a> of the <a href="https://www.marxists.org/archive/marx/works/1864/iwma/index.htm" rel="external noopener">International Working Men’s
  Association</a>, of November 1864, we said: </p>

  <p>“If the emancipation of the working classes requires
  ...
  <p>“Vindicate the simple laws of morals and justice,
  which ought to govern the relations of private individuals, as the laws
  paramount of the intercourse of nations.” </p>
  ...
  the plebiscite<sup class="cc-text-note-inline"><a href="#A" id="Ab">[A]</a></sup> he
  ...
  <p>The war plot of July [19] 1870<sup class="cc-text-note-inline"><a href="#B" id="Bb">[B]</a></sup> is but an amended edition of the <em>coup
  d’etat</em> of December 1851. At first view, the thing seemed so absurd
  ...
  subsidies – even <a href="https://www.marxists.org/glossary/people/t/h.htm#thiers-louis-adolphe" rel="external noopener">Thiers</a>
  ...
  In the <em>Reveil</em> of July 12, they published their manifesto “to
  the Workmen of all Nations,” from which we extract the following few
  passages: </p>

  <p>“Once more,” they say, “on the pretext of
  ...
  <p>“Brothers in Germany! Our division would only result
  in the complete triumph of the despotism on both sides of the Rhine... </p>

  <p>“Workmen of all countries! Whatever may for the
  ...
  <p>“The war, is it just? No! The war, is it national?
  ...
  protestation of the International against the war.” </p>

  <p>These protestations expressed the true sentiments of the French working
  people, as was soon shown by a curious incident. The <a href="https://www.marxists.org/glossary/orgs/d/e.htm#december-10-society" rel="external noopener">Band of the
  10th of December</a>, first organized under the presidency of Louis
  Bonaparte, having been masqueraded into <em>blouses</em> <span class="cc-text-note-inline">[i.e., to appear as common workers] </span>and let loose on
  the streets of Paris, there to perform the contortions of war fever, the real
  workmen of the Faubourgs <span class="cc-text-note-inline">[suburbs, workers’
  ...
  <p>Whatever may be the incidents of Louis Bonaparte’s war with Prussia,
  ...
  <p>“We are the enemies of all wars, but above all of
  ...
  <p>“In the name of German Democracy, and especially of
  ...
  our friends and the despots of all countries our enemies.” </p>

  <p>The Berlin branch of the International has also replied to the Paris
  manifesto: </p>

  <p>“We,” they say, “join with heart and hand
  ...
  the Prut.<sup class="cc-text-note-inline"><a href="#C" id="Cb">[C]</a></sup> Whatever
  ...
  call for, or accept the help of, the <a href="https://www.marxists.org/glossary/terms/c/o.htm#cossacks" rel="external noopener">Cossack</a>. Let them
  ...
  International Working Men’s Association. </p>
  ...
  <p class="cc-text-note"><sup class="cc-text-note-inline"><a href="#Ab" id="A">[A]</a></sup> A plebiscite is a direct vote by an electorate of a
  ...
  <p class="cc-text-note"><sup class="cc-text-note-inline"><a href="#Bb" id="B">[B]</a></sup> The date when Napoleon III declared war on <a href="https://www.marxists.org/glossary/places/p/r.htm#prussia" rel="external noopener">Prussia</a>. </p>

  <p class="cc-text-note"><sup class="cc-text-note-inline"><a href="#Cb" id="C">[C]</a></sup> The river Prut, rising in the southwestern Ukraine and
